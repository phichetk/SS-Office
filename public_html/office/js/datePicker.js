...
var days = new Array("อา", "จ", "อ", "พ", "พฤ", "ศ", "ส");
today = new getToday();	
var element_id;
...
function newCalendar() 
{
	...
	for (var intWeek = 0; intWeek < tableCal.rows.length;  intWeek++)
			 ...
			 intDay++)
	 {
		  ...
		  if(day == daily)
		  {
				document.all.todayday.innerText= "วันที่: " + newCal.getFullYear() + "-" + 
        ...
        function getDate() 
		 {
            ...
            if ("TD" == event.srcElement.tagName)
			   ...
			   { 
			   	 ArrMonth=new Array("","01","02","03","04","05","06","07","08","09","10","11","12");
				 ...
				 {day="0"+event.srcElement.innerText;}
				 else{day=event.srcElement.innerText;}
				 //document.all[element_id].value=Year+"-"+ArrMonth[mn] +"-"+day;
		         document.all[element_id].value=Year+"-"+ArrMonth[mn] +"-"+day;
				 document.all.calendar.style.display="none";
			 }
		 }
