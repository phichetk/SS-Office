            ...
            <table>
                ...
                <tbody>
                     <tr bgcolor="#FFCC00"> 
                         ...
                         <tr>
                              <td><a  href="./main.php?myKey=Receipt-Report-Txt"  >TXT</a> || 
...
?>
                ...
                <tr bgcolor="#CFE4E9"> 
                	<td><A href='main.php?myKey=Receipt-Issue-Edit&TransectionID=<?echo  intval($ROW_RECEIPT_REPORT['ID']); ?>' ><? echo $ROW_RECEIPT_REPORT['IssueDate']; ?></A></td>
                    ...
                    <td><A href='../post/post.php?GID=<?=$ROW_RECEIPT_REPORT['GID']?>' target='_blank' >พิมพ์ซอง</A></td>
                    <td><A href='billprint.php?TransectionID=<?=$ROW_RECEIPT_REPORT['ID']?>' target='_blank' >พิมพ์ใบเสร้จ</A></td>
                </tr>
