...
$SQL_POST = "SELECT * FROM ss_billing_customer WHERE ID='".$GID."'";
...
$pdf->Image('siamsoft-logo.jpg', 4, 55, 0,20);
$pdf->SetFont('DilleniaUPC','B',14);
$SS_L0 ="";
$pdf->MultiCell(0,53, $SS_L0, 0, 'L');

$SS_MYCOMPANY_NAME ="                                          ";
$SS_MYCOMPANY_NAME .="ºÃÔÉÑ· ÊÂÒÁ«Í¿·ì´Í·¤ÍÁ ¨Ó¡Ñ´    ÊÓ¹Ñ¡§Ò¹ãË­è";
$pdf->MultiCell(0,0, $SS_MYCOMPANY_NAME, 0, 'L');

$pdf->MultiCell(0,5, $SS_L0, 0, 'L');

$SS_MYCOMPANY_ADDRESS ="                                          ";
$SS_MYCOMPANY_ADDRESS .="51 «ÍÂÍèÍ¹¹Øª65 áÂ¡9 ¶¹¹ÍèÍ¹¹Øª á¢Ç§»ÃÐàÇÈ à¢µ»ÃÐàÇÈ ¡ÃØ§à·¾Ï 10250";
$pdf->MultiCell(0,0, $SS_MYCOMPANY_ADDRESS, 0, 'L');

$pdf->MultiCell(0,5, $SS_L0, 0, 'L');

$SS_MYCOMPANY_TAX_ID ="                                          ";
$SS_MYCOMPANY_TAX_ID .="àÅ¢»ÃÐ¨ÓµÑÇ¼ÙéàÊÕÂÀÒÉÕ 0105550004177";
