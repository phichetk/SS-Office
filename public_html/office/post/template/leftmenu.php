<table width="100%" height="700" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" class="style_menu">
		...
		d.add(0,-1,'MainMenu','#');	
		d.add(10,0,'  พิมพ์หน้าซองไปรษณีย์');						   				   
							d.add(11,10,' เพิ่มผู้ส่ง','main.php?myKey=APadd');
                            d.add(12,10,' รายการพิพม์ซองใหม่','main.php?myKey=newtaxw');
                            d.add(13,10,' รายการผู้นำส่ง','main.php?myKey=APlist');
                            d.add(14,10,' รายการจ่าหน้าซอง','main.php?myKey=report');
