	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
     	...
     	<td width="30"><a href="../../../../pla-all/public_html/office/main.php"><img src="images/pla-logo.jpg" width="300" height="81"></a></td>
      ...
      <tr>
        <td colspan="2" class="rmenu"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td >&nbsp;</td>
            <td ><a href="post/main.php">ส่งไปรษณีย์</a> </td>
            <td ><a href="receipt/main.php">ออกใบเสร็จ</a> </td>
            <td ><a href="wtax/main.php">หัก ณที่จ่าย</a> </td>
            <td ><a href="cheque/main.php">จ่ายเช็ค</a> </td>
            <td ><a href="expend/main.php">ค่าใช้จ่าย</a> </td>
            <td >&nbsp;</td>
          </tr>
        </table></td>
      </tr>
