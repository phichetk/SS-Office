...
<meta content="text/html; charset=iso-8859-11" http-equiv="Content-Type" />
<link href="pics/homescreen.gif" rel="apple-touch-icon" />
<meta content="minimum-scale=1.0, width=device-width, maximum-scale=0.6667, user-scalable=no" name="viewport" />
<link href="css/style.css" rel="stylesheet" media="screen" type="text/css" />
<script src="javascipt/functions.js" type="text/javascript"></script>
<title>web บน iphone - Embed RSS feeds into your iPhone website.</title>
...
<div id="footer">
	...
	<a class="noeffect" href="http://www.siamsoft.com">บริษัท สยามซอฟท์ดอทคอท จำกัด</a></div>
</body>
</html>
