<?php /* Smarty version 2.6.7, created on 2005-11-17 13:00:49
         compiled from simpleGreen/admin.regdomain.form.tpl */ ?>
...
">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="28%"><?php echo $this->_tpl_vars['domain'];  echo $this->_tpl_vars['product_info'][3]; ?>
</td>
            <td width="12%">Price</td>
            <td width="35%">$<?php echo $this->_tpl_vars['cur_price']; ?>
...
">
          ...
          <tr> 
            <td width="39%">Address 1</td>
            <td width="61%"> 
              <input type="text" name="t_address1" value="<?php echo $this->_tpl_vars['r_address1']; ?>
" size="30">
              <font color="#990000">*</font></td>
          </tr>
          <tr> 
...
<?php if ($this->_tpl_vars['product_info'][3] == ".us"): ?>
