              ...
              <table width="80%" border="0" cellspacing="1" cellpadding="3" align="center" bgcolor="#000000">
                <tr> 
                  ...
                  <td height="22" width="57%" bgcolor="#DBD9C7"> 
                    <input type="password" name="admin_password1"  size="100" value="<?php echo $admin_password1 ?>">
                  </td>
                </tr>
                <tr> 
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Confirm 
                    Password *</font></b></td>
                  <td height="22" width="57%" bgcolor="#DBD9C7"> 
                    <input type="password" name="admin_password2" value="<?php echo $admin_password2 ?>">
                  </td>
                </tr>
                <tr> 
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Super-Administrator 
                ...
                <tr> 
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Super-Administrator 
                    Dept. *</font></b></td>
                  <td height="22" width="57%" bgcolor="#DBD9C7"> 
                    <input type="text" name="admin_dept" value="<?php echo $admin_dept ?>">
                  </td>
                </tr>
                <tr>
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><font size="2"><b>Super-Administrator 
                    E-mail *</b></font> </td>
                  <td height="22" width="57%" bgcolor="#DBD9C7">
                    <input type="text" name="support_email" value="<?php echo $support_email ?>">
                  </td>
                </tr>
              </table>
              <br>
...
?>
                ...
                <tr> 
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Website 
                    Title *</font></b></td>
                  <td height="22" width="57%" bgcolor="#DBD9C7"> 
                    <input type="text" name="website_title" size="30" value="<?php echo $website_title ?>">
                  </td>
                </tr>
                <tr> 
                  <td height="22" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Website 
                    Copyright * </font></b></td>
                  <td height="22" width="57%" bgcolor="#DBD9C7"> 
                    <input type="text" name="website_copyright" size="30" value="<?php echo $website_copyright ?>">
                  </td>
                </tr>
                <tr> 
                  <td height="34" width="43%" bgcolor="#FFCC00" align="center"><b><font size="2">Pagesize *</font></b></td>
                  <td height="34" width="57%" bgcolor="#DBD9C7"> 
                    <input type="text" name="website_pagesize" value="<?php echo $website_pagesize ?>">
                  </td>
                </tr>
              </table>
              <br>
