...
<br />
<br />
<b style='font-size: 16px'>FTPD.PHP</b>
<style type="text/css">
a {
	color: #000000;
...
<fieldset><legend><b><a href="./ftpd-display.php">display</a></b> || <b><a href="./ftpd.php">edit</a></b></legend>
<table align='center'>
...
{
   //echo $SPdata1[$i];
   $SPdataIP = split(" # ",$SPdata1[$i],2);
   //echo  "IP=".$SPdataIP[0];
   //$IPFull1 = $SPdataIP[0];
   //echo  "IP=".$IPFull1;
  
        $SPIPAll = explode('.',$SPdataIP[0],4);
         //print_r($SPIPAll);
            $IP1=trim($SPIPAll[0]);
            $IP2=trim($SPIPAll[1]);
            $IP3=trim($SPIPAll[2]);
         ...
         $SPdataDetail1 = split(" ",$SPdataIP[1],7);
         //echo  "Detail".$SPdataDetail1[0];
            //print_r($SPdataDetail1);
            $Detail1=$SPdataIP[1];
            //$Detail2="";
 /*           
        if($SPdataDetail1[0]=="(ftpd)"||$SPdataDetail1[4]=="ftpd"||$SPdataDetail1[4]=="ftpd")
        {    $IPPort ="21";  }
        if($SPdataDetail1[0]=="(smtpauth)"||$SPdataDetail1[4]=="smtpauth"||$SPdataDetail1[5]=="smtpauth")
        {    $IPPort ="25";  }
        if($SPdataDetail1[0]=="(pop3d)"   ||$SPdataDetail1[4]=="pop3d"   ||$SPdataDetail1[5]=="pop3d")
        {    $IPPort ="110";  }
        if($SPdataDetail1[0]=="(cpanel)"||$SPdataDetail1[4]=="cpanel"||$SPdataDetail1[4]=="cpanel")
        {    $IPPort ="2082";  }
        echo "IP=".$IP1.".".$IP2.".".$IP3.".".$IP4."Port=".$IPPort ;
        echo "\n";
  */ 
...
$SQL_INSERT_CSF .= "`IP4` ,";
$SQL_INSERT_CSF .= "`Port` ,";
$SQL_INSERT_CSF .= "`Detail2`";
$SQL_INSERT_CSF .= ")VALUES (";
$SQL_INSERT_CSF .= "  '".$IP1."',  ";
$SQL_INSERT_CSF .= "  '".$IP2."',  ";
$SQL_INSERT_CSF .= "  '".$IP3."',  ";
$SQL_INSERT_CSF .= "  '".$IP4."',  ";
$SQL_INSERT_CSF .= "  '".$IPPort."'," ;
